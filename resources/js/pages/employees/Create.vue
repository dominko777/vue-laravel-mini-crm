<template>
    <div class="container">
        <h4>Создание работника</h4>
        <div class="row">
            <form class="col s12" @submit.prevent="onSubmit">
                <div class="row">
                    <div class="input-field col s12">
                        <input v-model.lazy="first_name" id="email" type="text" class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input v-model.lazy="last_name" id="email" type="text" class="validate">
    ...
    export default {
        ...
        methods: {
            onSubmit() {
                ...
                this.axiosInstance.post('employees/create', data).then(response => {
